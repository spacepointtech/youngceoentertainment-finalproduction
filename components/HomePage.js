...
//       {/* Hero Section */}
//       <div className="absolute top-6 mt-40 left-8 w-11/12 md:w-4/5 max-w-[1207px] p-6">
//         <div className="text-left ml-4 md:ml-10">
//           <h1 className="text-white text-[8vw] sm:text-[6vw] lg:text-[4vw] xl:text-[64px] font-bold font-Rubik leading-tight">
//             Unlock Global Music
//           </h1>
//           <h1 className="text-white text-[8vw] sm:text-[6vw] lg:text-[4vw] xl:text-[64px] font-bold font-Rubik leading-tight">
//             Distribution in Minutes!
//           </h1>
//           <p className="text-[#9f9fa1] text-sm sm:text-base md:text-lg xl:text-[22px] font-normal leading-relaxed">
//             Your Gateway to Seamless Music Distribution and Artist Growth.
//           </p>
//         </div>
//         <Link href="/signup">
...
//       {/* Disclaimer Modal */}
//       {showDisclaimer && (
//         <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-70 font-poppins px-4">
//           <div className="bg-[#191919] p-6 sm:p-8 rounded-lg text-left max-w-lg md:max-w-3xl w-full shadow-[0_0_20px_#e97f18] border border-[#e97f18]">
//             <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-4 sm:mb-6 text-[#e97f18]">
//               Welcome to Young CEO Entertainment!
//             </h2>
//             <p className="text-sm sm:text-base mb-2 sm:mb-4 text-[#AAAAAA] text-justify">
//               By using our website and services, you agree to the following terms and conditions:
//             </p>
//             <p className="text-sm sm:text-base mb-2 sm:mb-4 text-[#AAAAAA] text-justify">
//               <strong className="text-white font-bold">Ownership of Content:</strong> All songs and musical content distributed through our service remain the property of their respective owners. Young CEO Entertainment does not claim any ownership rights over the content provided by users.
//             </p>
//             <p className="text-sm sm:text-base mb-2 sm:mb-4 text-[#AAAAAA] text-justify">
//               <strong className="text-white font-bold">Dispute Resolution:</strong> Young CEO Entertainment has no standing in any disputes arising from the use of third-party samples, vocals, beats, or other elements in the distributed content. Any disputes or legal issues must be resolved directly between the content owner and the third party. Young CEO Entertainment will not be liable for any damages of any kind arising from the use of this website or from any information, content, materials, products, or services included on or otherwise made available to you through this website.
//             </p>
//             <div className="flex justify-center">
//               <button
//                 onClick={handleAgree}
//                 className="mt-4 sm:mt-6 bg-[#e97f18] text-white font-poppins px-8 sm:px-12 py-4 sm:py-5 rounded-2xl text-base sm:text-lg"
//               >
//                 I Agree
//               </button>
//             </div>
...
export default function Home() {
  ...
  return (
    <div className="h-screen relative bg-black">
      ...
      {/* Hero Section */}
      <div className="absolute top-6 mt-40 left-8 w-11/12 md:w-4/5 max-w-[1207px] p-6 content-container">
        <div className="text-left ml-4 md:ml-10">
          <h1 className="text-white text-[8vw] sm:text-[6vw] lg:text-[4vw] xl:text-[64px] font-bold font-Rubik leading-tight">
            Unlock Global Music
          </h1>
