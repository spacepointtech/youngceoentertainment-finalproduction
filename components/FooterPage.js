...
export default function Footer() {
  ...
  return (
            ...
            <div className="w-32 flex-col justify-start items-start gap-6 inline-flex relative">
              ...
              <div className="absolute top-[-15px] right-[-130px]">
                <Image
                  ...
                  width={117}
                  height={96}
                  className="ml-48 w-[117px] h-[96px]"
                />
              </div>
            </div>
          </div>
    ...
    <div className="w-[204px] left-[619px] top-[726px] absolute opacity-40 text-center text-[#eeeff0] text-xs font-medium ">Young Ceo Entertainment © 2024 </div>
    </div>
  );
}
