...
//             <div className="w-[210px] h-[52px] left-0 top-0 absolute rounded-lg border border-[#ebebeb]" />
//             <div className="left-[38px] top-[11px] absolute text-center text-white text-xl font-normal font-['Poppins']">Global Reach</div>
//         </div>
//         <div className="w-[268px] h-[52px] left-0 top-[104.28px] absolute">
//             <div className="w-[210px] h-[52px] left-0 top-0 absolute rounded-lg border border-[#ebebeb]" />
//             <div className="left-[38px] top-[11px] absolute text-center text-white text-xl font-normal font-['Poppins']">Simple & Fast</div>
//         </div>
//         <div className="w-[268px] h-[52px] left-0 top-[176.28px] absolute">
//             <div className="w-[210px] h-[52px] left-0 top-0 absolute rounded-lg border border-[#ebebeb]" />
//             <div className="left-[23px] top-[11px] absolute text-center text-white text-xl font-normal font-['Poppins']">Affordable Plans</div>
//         </div>
//         <div className="w-[268px] h-[52px] left-0 top-[248.28px] absolute">
//             <div className="w-[210px] h-[52px] left-0 top-0 absolute rounded-lg border border-[#ebebeb]" />
//             <div className="left-[14px] top-[11px] absolute text-center text-white text-xl font-normal font-['Poppins']">Powerful Analytics</div>
//         </div>
//         <div className="w-[268px] h-[52px] left-0 top-[320.28px] absolute">
//             <div className="w-[210px] h-[52px] left-0 top-0 absolute rounded-lg border border-[#ebebeb]" />
//             <div className="left-[48px] top-[11px] absolute text-center text-white text-xl font-normal font-['Poppins']">Smart Links</div>
//         </div>
//         <div className="w-[268px] h-[52px] left-0 top-[392.28px] absolute">
//             <div className="w-[210px] h-[52px] left-0 top-0 absolute rounded-lg border border-[#ebebeb]" />
//             <div className="left-[11px] top-[11px] absolute text-center text-white text-xl font-normal font-['Poppins']">Dedicated Support</div>
//         </div>
