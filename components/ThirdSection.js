...
//     >
//     <div className="text-center p-20">
//          <span className="text-white lg:text-[40px] md:text-[40px] font-bold">Why </span>
//          <span className="text-[#e97f18] md:text-[40px] lg:text-[40px] font-bold">Artists</span>
//          <span className="text-white md:text-[40px] lg:text-[40px] font-bold"> </span>
//          <span className="text-[#e97f18] md:text-[40px] lg:text-[40px] font-bold">Trust</span>
//          <span className="text-white md:text-[40px] lg:text-[40px] font-bold"> Young CEO Entertainment</span>
//          <div className="text-center text-white lg:text-2xl md:text-xl font-normal mt-1">More than distribution—your partner in success.</div>  
//          </div>  
        
        
//     <div className="lg:w-[1093px]  lg:h-[808.24px]  lg:left-[203px] top-[213.69px] absolute">
//     <Link href="/signup"> 
//         <div className="lg:w-[449px] md:[1300px] lg:mt-0 md:mt-20 lg:h-[62px] lg:left-[345px] top-[544.97px] absolute justify-start items-start gap-[41.20px] inline-flex">
//             <div className="grow shrink basis-0 h-[62px] px-[74px] py-4 rounded-lg border border-[#e97f18] text-[#e97f18] font-semibold text-xl justify-center items-center gap-2.5 flex hover:bg-[#e97f18] hover:text-white cursor">
//               Join Now 
//             </div>
//         </div>
...
//         <div className="absolute top-[26px] left-[212px] w-[58px] h-[1px] border-separate border-t border-white"></div>
//             <div className="w-[210px] h-[52px] left-0 top-0 absolute rounded-lg border border-[#ebebeb]" />
//             <div className="left-[11px] top-[11px] absolute md:text-xl text-center text-white lg:text-xl font-normal ">Dedicated Support</div>
//         </div>
//         <div className="left-[310px] top-[114.97px] absolute text-center text-white lg:text-xl font-normal ">Upload once, distribute everywhere in minutes.</div>
//         <div className="left-[310px] top-[186.97px] absolute text-center text-white lg:text-xl font-normal ">Tailored pricing for independent artists and labels.</div>
//         <div className="left-[310px] top-[258.97px] absolute text-center text-white lg:text-xl font-normal ">Track performance and audience insights with ease</div>
//         <div className="left-[310px] top-[330.97px] absolute text-center text-white lg:text-xl font-normal ">Earn and manage 100% of your royalties hassle-free.</div>
//         <div className="left-[310px] top-[402.97px] absolute text-center text-white lg:text-xl font-normal "> Share your music with one link across all platforms.</div>
//         <div className="left-[310px] top-[474.97px] absolute text-center text-white lg:text-xl font-normal "> 24/7 assistance to help you every step of the way.</div>
//         <div className="left-[310px]  top-[43.28px] absolute text-center text-white lg:text-xl font-normal ">Get your music on 150+ platforms, including Spotify, Apple Music, and Amazon.</div>
//     </div>
// </div>
