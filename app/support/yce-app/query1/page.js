...
import { FaSearch, FaChevronRight, FaChevronDown, FaEdit, FaThumbsUp, FaThumbsDown, FaUserAlt, FaMobileAlt } from 'react-icons/fa';
  ...
  return (
    <div className="support-page bg-black text-white font-poppins">
      ...
      <div className="container mx-auto px-4 py-4">
        <Link href="/support/yce-app" className="back-link ml-1 text-white text-lg">
          &lt; Back
        </Link>
      </div>
      ...
      <div className="container mx-auto px-6 pb-16">
        <div className="faq-header flex items-center justify-between mb-6">
          <div className="flex flex-col">
            ...
            <h2 className="text-4xl font-semibold">YCE <span className='text-[#e97f18]'>  Application </span></h2>
    ...
    <div className="text-white text-4xl font-bold font-['Poppins']"> How Can I get access to YCE App? </div>
    <div className="self-stretch h-5" />
    <div className="self-stretch"><span className="text-[#ebebeb] text-base font-normal font-['Poppins'] leading-normal">  
        
    Young CEO Entertainment Application is currently under development.
         </span>
