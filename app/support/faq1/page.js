...
const FaqComponent = () => {
  ...
  return (
    ...
    <div className="self-stretch"><span className="text-[#ebebeb] text-base font-normal font-['Poppins'] leading-normal">Just </span><span className="text-[#ebebeb] text-base font-normal font-['Poppins'] hover:underline leading-normal"> <Link href="/signup"> Sign up to YCE </Link></span><span className="text-[#ebebeb] text-base font-normal font-['Poppins'] leading-normal"> for free with your email address 🚀<br/>From your YCE Dashboard, you'll have the choice of creating a new Standard Release or Electronic/Dance Music Release! 🎶<br/>Choose the one that's right for you and follow the step-by-step process on the YCE Release Builder.<br/></span></div>
