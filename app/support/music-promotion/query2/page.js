...
const FaqComponent = () => {
  ...
  return (
    ...
    <div className="text-white text-4xl font-bold font-['Poppins']">What promotional services do you offer?</div>
...
Start a YCE Promo campaign and collaborate with our team to boost your social media presence and get your tracks featured on music blogs.

Easily launch, manage, and track your campaign progress from your account dashboard.
         </span>
