...
import { FaSearch, FaChevronRight, FaChevronDown, FaEdit, FaThumbsUp, FaThumbsDown, FaUserAlt, FaChartLine } from 'react-icons/fa';
  ...
  return (
    <div className="support-page bg-black text-white font-poppins">
      ...
      <div className="container mx-auto px-4 py-4">
        <Link href="/support/music-promotion" className="back-link ml-1 text-white text-lg">
          &lt; Back
        </Link>
      </div>
      ...
      <div className="container mx-auto px-6 pb-16">
        <div className="faq-header flex items-center justify-between mb-6">
          <div className="flex flex-col">
            ...
            <h2 className="text-4xl font-semibold">Music <span className='text-[#e97f18]'>  Promotion </span></h2>
    ...
    <div className="text-white text-4xl font-bold font-['Poppins']"> What is Chartbreaker? </div>
    <div className="self-stretch h-5" />
    <div className="self-stretch"><span className="text-[#ebebeb] text-base font-normal font-['Poppins'] leading-normal">  
        
   
Join hundreds of artists using Chartbreaker to increase your chances of chart success! 🎶

Chartbreaker offers the best value promo services, giving you access to exclusive tools used by major labels, with a proven blueprint for success! 🥇

Features include:

Pre-release support 🤝
Global chart registration 🌍
Guaranteed playlisting 🎵
Optimized social graphics 📊
PR guide & contact list 🗞
EPK builder 📰
         </span>
