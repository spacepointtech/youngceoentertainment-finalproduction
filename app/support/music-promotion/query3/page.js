...
const FaqComponent = () => {
  ...
  return (
    ...
    <div className="text-white text-4xl font-bold font-['Poppins']">What happens once I've purchased Chartbreaker?</div>
    <div className="self-stretch h-5" />
    <div className="self-stretch"><span className="text-[#ebebeb] text-base font-normal font-['Poppins'] leading-normal">  
        
    After purchasing your Chartbreaker package, you'll get a confirmation email with all the necessary links.

The email will guide you on how to access each Chartbreaker feature and maximize the industry tools 🛠

You can use each feature within 12 months of your purchase 🗓
         </span>
