...
const FaqComponent = () => {
  ...
  return (
    ...
    <div className="text-white text-4xl font-bold font-['Poppins']">How do I remove a release from stores?</div>
    <div className="self-stretch h-5" />
    <div className="self-stretch"><span className="text-[#ebebeb] text-base font-normal font-['Poppins'] leading-normal">You can remove your music from stores at any time. Simply log into your YCE Dashboard go to the Recent Releases section and Click the dropdown menu next to the release you'd like to remove and click Takedown.</span></div>
