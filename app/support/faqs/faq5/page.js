...
const FaqComponent = () => {
  ...
  return (
    ...
    <div className="text-white text-4xl font-bold font-['Poppins']"> Will YCE promote my music? </div>
    <div className="self-stretch h-5" />
    <div className="self-stretch"><span className="text-[#ebebeb] text-base font-normal font-['Poppins'] leading-normal"> Need some help promoting your next big release? 🚀 <br/>  </span>

         <span>You can start a YCE Promo campaign and work with our team to raise your social media game and push your tracks out to music blogs. 

    </span>

       <span> What's more - you can launch, manage and track your campaign progress directly from your account dashboard.
        </span>
