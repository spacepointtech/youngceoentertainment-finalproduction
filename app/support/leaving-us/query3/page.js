...
const FaqComponent = () => {
  ...
  return (
    ...
    <div className="text-white text-4xl font-bold font-['Poppins']"> Can I withdraw royalties without an active subscription? </div>
    <div className="self-stretch h-5" />
    <div className="self-stretch"><span className="text-[#ebebeb] text-base font-normal font-['Poppins'] leading-normal">  
    An active YCE subscription is required to withdraw royalties and release new music. Without it, your releases may be removed from platforms, unless you have a Pro or Label plan with Release Protection.
         </span>
