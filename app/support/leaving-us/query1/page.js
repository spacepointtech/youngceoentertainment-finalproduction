...
import { FaSearch, FaChevronRight, FaChevronDown, FaEdit, FaThumbsUp, FaThumbsDown, FaUserAlt, FaRegSadTear } from 'react-icons/fa';
  ...
  return (
    <div className="support-page bg-black text-white font-poppins">
      ...
      <div className="container mx-auto px-4 py-4">
        <Link href="/support/leaving-us" className="back-link ml-1 text-white text-lg">
          &lt; Back
        </Link>
      </div>
      ...
      <div className="container mx-auto px-6 pb-16">
        <div className="faq-header flex items-center justify-between mb-6">
          <div className="flex flex-col">
            <FaRegSadTear className="text-4xl mb-4 text-[#A6A6A6]" />
            <h2 className="text-4xl font-semibold">Leaving <span className='text-[#e97f18]'>  Us </span></h2>
    ...
    <div className="text-white text-4xl font-bold font-['Poppins']"> What happens if I stop paying my subscription? </div>
    <div className="self-stretch h-5" />
    <div className="self-stretch"><span className="text-[#ebebeb] text-base font-normal font-['Poppins'] leading-normal">  
    If you stop paying for your Ditto subscription, your releases may eventually be removed from stores. To keep them live, renew your plan.

If you want your music taken down, request a takedown through your account. Note: An active subscription is required to withdraw royalties. 
         </span>
