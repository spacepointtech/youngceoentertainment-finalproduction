...
const FaqComponent = () => {
  ...
  return (
    ...
    <div className="text-white text-4xl font-bold font-['Poppins']"> Does Young CEO Entertainment offer a free trial? 🎉 </div>
    <div className="self-stretch h-5" />
    <div className="self-stretch"><span className="text-[#ebebeb] text-base font-normal font-['Poppins'] leading-normal">  

    We don’t offer a free trial, but you can distribute a single track at a minimal fee to test out our platform. However, please note that this option doesn’t give access to the full dashboard features. For complete access, you’ll need to select a subscription plan. 🎶        
         </span>
