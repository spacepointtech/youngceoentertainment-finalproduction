...
const FaqComponent = () => {
  ...
  return (
    ...
    <div className="text-white text-4xl font-bold font-['Poppins']"> How do I find my YouTube Topic Channel ID?  </div>
...
Scroll down to find your Channel ID under Account Information.
         </span>
