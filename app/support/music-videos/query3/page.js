...
const FaqComponent = () => {
  ...
  return (
    ...
    <div className="text-white text-4xl font-bold font-['Poppins']"> When and how do I get paid video royalties?</div>
    <div className="self-stretch h-5" />
    <div className="self-stretch"><span className="text-[#ebebeb] text-base font-normal font-['Poppins'] leading-normal">  
    You get paid video royalties monthly, typically within 30-60 days after the end of a reporting period. Payments are processed through your registered payment method once the minimum payout threshold is met.
         </span>
