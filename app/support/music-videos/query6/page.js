...
const FaqComponent = () => {
  ...
  return (
    ...
    <div className="text-white text-4xl font-bold font-['Poppins']"> How do I find my YouTube channel ID?   </div>
    <div className="self-stretch h-5" />
    <div className="self-stretch"><span className="text-[#ebebeb] text-base font-normal font-['Poppins'] leading-normal">  
    To find your YouTube Topic Channel ID:

1. Search for your artist name followed by "topic" on YouTube (e.g., Artist Name - Topic).
2. Open the topic channel.
3. The Channel ID is the string of characters in the URL after /channel/ (e.g., UC...).
         </span>
