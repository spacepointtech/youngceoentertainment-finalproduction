...
// import { FaSearch, FaChevronRight, FaUserAlt, FaCheck, FaEdit, FaCloudUploadAlt, FaDollarSign, FaDesktop, FaClipboard, FaBook, FaChartLine, FaVideo } from 'react-icons/fa';
...
//             <h2 className="text-4xl font-semibold font-poppins"> Music <span className='text-[#e97f18]'> Videos </span></h2>
...
// const faqItems = [
//     { question: 'Do you offer YouTube services?', 
//         url: '/support/music-videos/query1' 
//     },
...
import Link from 'next/link';
import React, { useState } from 'react';
import { FaSearch, FaChevronRight, FaUserAlt, FaCheck, FaEdit, FaRegClipboard, FaDollarSign, FaDeskpro, FaDesktop, FaChartLine, FaVideo } from 'react-icons/fa';
    ...
    <div className="support-page bg-black text-white font-poppins">
      ...
      <div className="container mx-auto px-4 md:px-6 pb-16">
        <div className="faq-header flex flex-col md:flex-row items-start md:items-center justify-between mb-6">
          <div className="flex flex-col">
            <FaVideo className="text-2xl md:text-4xl mb-4 text-[#A6A6A6]" />
            <h2 className="text-2xl md:text-4xl font-semibold">
             Music <span className='text-[#e97f18]'> Videos </span>
            </h2>
            <p className="text-lg md:text-xl text-[#EBEBEB] mb-4 md:mb-6">Advice on  releasing Music Videos</p>
