...
const FaqComponent = () => {
  ...
  return (
    ...
    <div className="text-white text-4xl font-bold font-['Poppins']"> I still haven’t received my Official Artist Channel - how long does this take?  </div>
    <div className="self-stretch h-5" />
    <div className="self-stretch"><span className="text-[#ebebeb] text-base font-normal font-['Poppins'] leading-normal">  
    Getting an Official Artist Channel typically takes 2-4 weeks after the request is submitted. If it’s delayed, contact your distributor to check the status with YouTube.
         </span>
