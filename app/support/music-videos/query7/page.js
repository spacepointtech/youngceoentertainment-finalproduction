...
import { FaSearch, FaChevronRight, FaChevronDown, FaEdit, FaThumbsUp, FaThumbsDown, FaUserAlt, FaVideo } from 'react-icons/fa';
  ...
  return (
    <div className="support-page bg-black text-white font-poppins">
      ...
      <div className="container mx-auto px-4 py-4">
        <Link href="/support/music-videos" className="back-link ml-1 text-white text-lg">
          &lt; Back
        </Link>
      </div>
      ...
      <div className="container mx-auto px-6 pb-16">
        <div className="faq-header flex items-center justify-between mb-6">
          <div className="flex flex-col">
            <FaVideo className="text-4xl mb-4 text-[#A6A6A6]" />
            <h2 className="text-4xl font-semibold">Music <span className='text-[#e97f18]'>  Video </span></h2>
    ...
    <div className="text-white text-4xl font-bold font-['Poppins']"> How do I get an Official Artist Channel on YouTube?   </div>
    <div className="self-stretch h-5" />
    <div className="self-stretch"><span className="text-[#ebebeb] text-base font-normal font-['Poppins'] leading-normal">  
    To get an Official Artist Channel on YouTube:

1. Ensure your music is distributed to YouTube via a distributor like Young CEO Entertainment.
2. Have a YouTube channel representing you as an artist.
3. Request channel verification through your distributor, who will coordinate with YouTube to merge your topic and artist channels.
         </span>
...
const faqItems = [
  ...
  { question: 'I still haven’t received my Official Artist Channel - how long does this take?', 
    url: '/support/music-videos/query8'  },
