...
const FaqComponent = () => {
  ...
  return (
    ...
    <div className="text-white text-4xl font-bold font-['Poppins']"> How does YouTube Content ID work? </div>
    <div className="self-stretch h-5" />
    <div className="self-stretch"><span className="text-[#ebebeb] text-base font-normal font-['Poppins'] leading-normal">  
    YouTube Content ID is a system that identifies and manages copyrighted content on the platform. It scans uploaded videos for matches against a database of registered content and allows rights holders to monetize, track, or block matching videos based on their preferences.
