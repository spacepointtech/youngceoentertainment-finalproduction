...
const FaqComponent = () => {
  ...
  return (
    ...
    <div className="text-white text-4xl font-bold font-['Poppins']"> How do I check if my music is live in stores?</div>
    <div className="self-stretch h-5" />
    <div className="self-stretch"><span className="text-[#ebebeb] text-base font-normal font-['Poppins'] leading-normal">  
        
    To verify that your release is live on the requested platforms, simply visit the stores and search for your music! 🔎🎵
 
   <p className='mt-1'>    You can review the stores you selected in the Release Builder under the Complete tab within the My Releases section of your dashboard.
   </p>
      <p className='mt-1'> 
      Click "View" from the dropdown menu next to your release, then navigate to the Store tab.
