...
const FaqComponent = () => {
  ...
  return (
    ...
    <div className="text-white text-4xl font-bold font-['Poppins']"> How do I withdraw royalties? 💸 </div>
    <div className="self-stretch h-5" />
    <div className="self-stretch"><span className="text-[#ebebeb] text-base font-normal font-['Poppins'] leading-normal">  
        
    To withdraw royalties, log in to your Young CEO Entertainment dashboard and go to the Royalties section. From there, you can request a withdrawal to your preferred payment method, such as PayPal, Payoneer, or bank transfer. Ensure your payout details are up to date to avoid any issues! 💰
         </span>
