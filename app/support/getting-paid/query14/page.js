...
const FaqComponent = () => {
  ...
  return (
    ...
    <div className="text-white text-4xl font-bold font-['Poppins']"> Can I withdraw royalties to PayPal? 💳 </div>
    <div className="self-stretch h-5" />
    <div className="self-stretch"><span className="text-[#ebebeb] text-base font-normal font-['Poppins'] leading-normal">  
    Yes, Young CEO Entertainment allows you to withdraw royalties to PayPal as long as your PayPal account is linked in the Payout Settings of your dashboard. Make sure your PayPal account is verified to avoid any issues. 💼      </span>
