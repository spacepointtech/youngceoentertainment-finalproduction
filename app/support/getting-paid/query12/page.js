...
const FaqComponent = () => {
  ...
  return (
    ...
    <div className="text-white text-4xl font-bold font-['Poppins']"> How do I view my sales data & earnings? 📊 </div>
    <div className="self-stretch h-5" />
    <div className="self-stretch"><span className="text-[#ebebeb] text-base font-normal font-['Poppins'] leading-normal">  
    You can view your sales data and earnings directly on your Young CEO Entertainment dashboard. Go to the Analytics or Royalties section to track your streams, sales, and earnings over time. 📅         
         </span>
