...
const FaqComponent = () => {
  ...
  return (
    ...
    <div className="text-white text-4xl font-bold font-['Poppins']"> Why do I need to enter my bank details again for royalty payouts? 🏦 </div>
    <div className="self-stretch h-5" />
    <div className="self-stretch"><span className="text-[#ebebeb] text-base font-normal font-['Poppins'] leading-normal">  
    
    You may need to re-enter your bank details if there has been an issue with your previous payment method or if you’re updating your details. This ensures that your royalties are paid accurately and promptly. 📋  </span>
