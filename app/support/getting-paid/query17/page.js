...
const FaqComponent = () => {
  ...
  return (
    ...
    <div className="text-white text-4xl font-bold font-['Poppins']">Bank transfer fees for royalty payouts 💳</div>
    <div className="self-stretch h-5" />
    <div className="self-stretch"><span className="text-[#ebebeb] text-base font-normal font-['Poppins'] leading-normal">  
    
    Bank transfer fees depend on your bank’s policies and the region you’re located in. Young CEO Entertainment does not charge fees for bank transfers, but your bank may. Be sure to check with your bank for any applicable fees. 💸
     </span>
