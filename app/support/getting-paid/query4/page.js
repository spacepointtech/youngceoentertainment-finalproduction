...
const FaqComponent = () => {
  ...
  return (
    ...
    <div className="text-white text-4xl font-bold font-['Poppins']"> How do I withdraw royalties with Payoneer? 💳 </div>
    <div className="self-stretch h-5" />
    <div className="self-stretch"><span className="text-[#ebebeb] text-base font-normal font-['Poppins'] leading-normal">  
    To withdraw royalties using Payoneer, simply link your Payoneer account to your Young CEO Entertainment dashboard in the Payout Settings section. After it’s linked, you can request royalty payouts, and the funds will be sent directly to your Payoneer account. 🌍
         </span>
