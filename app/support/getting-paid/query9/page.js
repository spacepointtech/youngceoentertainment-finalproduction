...
const FaqComponent = () => {
  ...
  return (
    ...
    <div className="text-white text-4xl font-bold font-['Poppins']"> How do I edit or remove split royalty payments from a release? ✏️ </div>
    <div className="self-stretch h-5" />
    <div className="self-stretch"><span className="text-[#ebebeb] text-base font-normal font-['Poppins'] leading-normal">  
               
    To edit or remove royalty splits, go to the Royalties Split section of your release in the dashboard. You can update the percentages or remove collaborators as needed. Changes made will be reflected in future payments. 🔄
         </span>
