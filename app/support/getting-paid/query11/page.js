...
const FaqComponent = () => {
  ...
  return (
    ...
    <div className="text-white text-4xl font-bold font-['Poppins']"> Why do I need to confirm my identity to receive royalties? 🆔 </div>
    <div className="self-stretch h-5" />
    <div className="self-stretch"><span className="text-[#ebebeb] text-base font-normal font-['Poppins'] leading-normal">  
               
    Confirming your identity is a security measure to ensure that payments are made to the correct individual. This process helps to comply with financial regulations and avoid fraud. It's a standard step to ensure your royalties are safely transferred. 🔒
         </span>
