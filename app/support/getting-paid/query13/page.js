...
const FaqComponent = () => {
  ...
  return (
    ...
    <div className="text-white text-4xl font-bold font-['Poppins']"> What are pending royalties? ⏳ </div>
    <div className="self-stretch h-5" />
    <div className="self-stretch"><span className="text-[#ebebeb] text-base font-normal font-['Poppins'] leading-normal">  
    Pending royalties are earnings that have been generated but have not yet been processed or paid out. These can be in the queue for review or awaiting confirmation from music stores before they’re paid to you. 💵         </span>
