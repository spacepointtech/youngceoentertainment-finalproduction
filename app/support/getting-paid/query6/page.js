...
const FaqComponent = () => {
  ...
  return (
    ...
    <div className="text-white text-4xl font-bold font-['Poppins']"> What does Pending License Verification mean? 🕒 </div>
    <div className="self-stretch h-5" />
    <div className="self-stretch"><span className="text-[#ebebeb] text-base font-normal font-['Poppins'] leading-normal">  
    "Pending License Verification" means that your release is undergoing checks to verify licensing, such as the rights to use certain music, samples, or trademarks. This process ensures that all content is compliant with store policies. ⏳
         </span>
