...
const FaqComponent = () => {
  ...
  return (
    ...
    <div className="text-white text-4xl font-bold font-['Poppins']"> How long before my release date should I upload my music? </div>
    <div className="self-stretch h-5" />
    <div className="self-stretch"><span className="text-[#ebebeb] text-base font-normal font-['Poppins'] leading-normal">  
        
    If possible, we recommend uploading your music at least 3-4 weeks before your planned release date. This gives us more time to process your release and map it to the correct stores and artist profiles.
   Uploading early also gives you more time to promote your music in the run-up to your release date. This is particularly important when it comes to pitching tracks for Spotify playlists through your Spotify for Artists account. 
         </span>
