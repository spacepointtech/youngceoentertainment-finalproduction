...
// import { FaSearch, FaChevronRight, FaUserAlt, FaCheck, FaEdit, FaCloudUploadAlt, FaDollarSign, FaDesktop, FaClipboard } from 'react-icons/fa';
...
//             <FaClipboard className="text-4xl mb-4 text-[#A6A6A6]" />
//             <h2 className="text-4xl font-semibold font-poppins"> Licensing, <span className='text-[#e97f18]'> Copyright & Metadata </span></h2>
      ...
      <div className="container mx-auto px-4 md:px-6 pb-16">
        <div className="faq-header flex flex-col md:flex-row items-start md:items-center justify-between mb-6">
          <div className="flex flex-col">
            ...
            <p className="text-lg md:text-xl text-[#EBEBEB] mb-4 md:mb-6">Learn about the rules & regs of music distrutions.</p>
