  ...
  return (
    <div className="support-page bg-black text-white font-poppins">
      ...
      <div className="container mx-auto px-4 py-4">
        <Link href="/support/making-edits" className="back-link ml-1 text-white text-lg">
          &lt; Back
        </Link>
      </div>
    ...
    <div className="text-white text-4xl font-bold font-['Poppins']"> Can I change my release date? </div>
