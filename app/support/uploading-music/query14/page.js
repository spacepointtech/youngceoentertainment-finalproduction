...
const FaqComponent = () => {
  ...
  return (
    ...
    <div className="text-white text-4xl font-bold font-['Poppins']">How do I choose a song snippet for TikTok and SmartLinks? 🎥</div>
    <div className="self-stretch h-5" />
    <div className="self-stretch"><span className="text-[#ebebeb] text-base font-normal font-['Poppins'] leading-normal">  
          
      
    When creating your release, you can choose a 30-second song snippet that will be used for TikTok and SmartLinks. The snippet should highlight the most engaging part of your song to attract listeners. You can select this in the Release Builder. 📱        </span>
