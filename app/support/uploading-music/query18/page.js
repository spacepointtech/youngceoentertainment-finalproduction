...
const FaqComponent = () => {
  ...
  return (
    ...
    <div className="text-white text-4xl font-bold font-['Poppins']">Can I add my lyrics to Instagram? 📱</div>
    <div className="self-stretch h-5" />
    <div className="self-stretch"><span className="text-[#ebebeb] text-base font-normal font-['Poppins'] leading-normal">  
          
    Yes! You can add your lyrics to Instagram Stories using the lyrics feature that platforms like Spotify support. Simply make sure you’ve entered your lyrics in the Release Builder, and they will be available for Instagram. 🎶
