...
const FaqComponent = () => {
  ...
  return (
    ...
    <div className="text-white text-4xl font-bold font-['Poppins']"> Can I leave my release's secondary genre blank? 🤔 </div>
    <div className="self-stretch h-5" />
    <div className="self-stretch"><span className="text-[#ebebeb] text-base font-normal font-['Poppins'] leading-normal">  
 
    You are not required to select a secondary genre for your release. If your music fits within one main genre, you can leave the secondary genre field blank. However, adding a secondary genre may help your music reach a wider audience by categorizing it more precisely. 🎶
         </span>
