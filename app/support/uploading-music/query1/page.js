  ...
  return (
    <div className="support-page bg-black text-white font-poppins">
      ...
      <div className="container mx-auto px-4 py-4">
        <Link href="/support/uploading-music" className="back-link ml-1 text-white text-lg">
          &lt; Back
        </Link>
      </div>
    ...
    <div className="text-white text-4xl font-bold font-['Poppins']"> Why am I blocked from uploading my music to Soundcloud? 🚫 </div>
    <div className="self-stretch h-5" />
    <div className="self-stretch"><span className="text-[#ebebeb] text-base font-normal font-['Poppins'] leading-normal">  

     If you're blocked from uploading music to SoundCloud, it may be due to an issue with the track's content or metadata. Make sure your release meets the platform’s guidelines and doesn't contain any copyrighted material. You may also want to check that your account is in good standing with SoundCloud. If you're unsure, contact SoundCloud support or reach out to us for further assistance. 📧        
