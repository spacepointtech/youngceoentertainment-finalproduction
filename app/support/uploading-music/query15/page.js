...
const FaqComponent = () => {
  ...
  return (
    ...
    <div className="text-white text-4xl font-bold font-['Poppins']">Can I add credits to my releases? 🎤</div>
    <div className="self-stretch h-5" />
    <div className="self-stretch"><span className="text-[#ebebeb] text-base font-normal font-['Poppins'] leading-normal">  
          
      
    Yes! You can add credits for writers, producers, and featured artists in the Release Builder. This is a great way to give credit to everyone who contributed to the music. 🎶      </span>
