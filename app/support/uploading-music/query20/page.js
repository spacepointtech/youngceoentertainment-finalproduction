...
const FaqComponent = () => {
  ...
  return (
    ...
    <div className="text-white text-4xl font-bold font-['Poppins']">How do I find my Amazon Music Artist ID? 🔍</div>
    <div className="self-stretch h-5" />
    <div className="self-stretch"><span className="text-[#ebebeb] text-base font-normal font-['Poppins'] leading-normal">  
          
    To find your Amazon Music Artist ID, go to Amazon Music for Artists, log in, and navigate to your artist profile. The Artist ID will be in the URL of your page. It’s typically a long string of numbers. 🔑                </span>
