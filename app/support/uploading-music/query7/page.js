...
const FaqComponent = () => {
  ...
  return (
    ...
    <div className="text-white text-4xl font-bold font-['Poppins']">What should I put for my record label? 🏷️</div>
    <div className="self-stretch h-5" />
    <div className="self-stretch"><span className="text-[#ebebeb] text-base font-normal font-['Poppins'] leading-normal">  
    If you are releasing music under Young CEO Entertainment, you can simply enter "Young CEO Entertainment" as the record label. If you are an independent artist with your own label, you can enter your label’s name here. 🎤    
        </span>
