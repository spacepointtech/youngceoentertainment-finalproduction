...
const FaqComponent = () => {
  ...
  return (
    ...
    <div className="text-white text-4xl font-bold font-['Poppins']">Can I add lyrics to my release? 🎶</div>
    <div className="self-stretch h-5" />
    <div className="self-stretch"><span className="text-[#ebebeb] text-base font-normal font-['Poppins'] leading-normal">  
          
      
    Yes, you can add lyrics to your release! Simply input the lyrics in the provided field during the release process. This allows platforms like Apple Music, Spotify, and others to display them for your listeners. 📜
            </span>
