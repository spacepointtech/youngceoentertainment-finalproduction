...
const FaqComponent = () => {
  ...
  return (
    ...
    <div className="text-white text-4xl font-bold font-['Poppins']"> Why isn't my artwork being accepted? 🎨 </div>
    <div className="self-stretch h-5" />
    <div className="self-stretch"><span className="text-[#ebebeb] text-base font-normal font-['Poppins'] leading-normal">  
 
    Artwork can be rejected if it doesn’t meet the platform's requirements. Make sure your artwork is:
     
     <ul className='list-inside list-disc'>
      <li> 
      In the correct dimensions (typically 3000x3000 pixels)
      </li>
      <li>
      In a supported file format (JPEG or PNG)
      </li>
          
      <li>
      Not containing any offensive or copyrighted material
      </li>

      <li>
      Properly formatted without excessive text or logos If the issue persists, try uploading the artwork again or contact us for guidance. 📸
      </li>
