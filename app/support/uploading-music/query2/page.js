...
const FaqComponent = () => {
  ...
  return (
    ...
    <div className="text-white text-4xl font-bold font-['Poppins']"> How do I change the track order on my release? 🔄 </div>
    <div className="self-stretch h-5" />
    <div className="self-stretch"><span className="text-[#ebebeb] text-base font-normal font-['Poppins'] leading-normal">  

    To change the track order of your release, simply go to the Young CEO Entertainment dashboard and click on the release you wish to edit. There, you can rearrange the track order before submitting the release for distribution. Make sure to save the changes after you adjust the order! 🎵     
         </span>
