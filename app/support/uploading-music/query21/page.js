...
const FaqComponent = () => {
  ...
  return (
    ...
    <div className="text-white text-4xl font-bold font-['Poppins']">How do I find my Audiomack Artist ID? 🔎</div>
    <div className="self-stretch h-5" />
    <div className="self-stretch"><span className="text-[#ebebeb] text-base font-normal font-['Poppins'] leading-normal">  
          
    To find your Audiomack Artist ID, visit your Audiomack Artist Profile page. The ID is usually located in the URL or in your account settings under artist info. 📱
    </span>
