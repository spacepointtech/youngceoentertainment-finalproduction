...
const FaqComponent = () => {
  ...
  return (
    ...
    <div className="text-white text-4xl font-bold font-['Poppins']">Can I re-release music I’ve already released with Young CEO Entertainment? 🔄</div>
    <div className="self-stretch h-5" />
    <div className="self-stretch"><span className="text-[#ebebeb] text-base font-normal font-['Poppins'] leading-normal">  
          
      
    Yes, you can re-release music you've previously released. When re-releasing, make sure to update any relevant details (such as new artwork or a new version of the track) to differentiate it from the original release. 🔄
                </span>
