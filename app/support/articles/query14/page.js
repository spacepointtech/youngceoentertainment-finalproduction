...
const FaqComponent = () => {
  ...
  return (
    ...
    <div className="text-white text-4xl font-bold font-['Poppins']"> Can I release a track that's over 10 minutes long? ⏱️ </div>
    <div className="self-stretch h-5" />
    <div className="self-stretch"><span className="text-[#ebebeb] text-base font-normal font-['Poppins'] leading-normal">  
         
    Yes! <span classname='font-bold'> Young CEO Entertainment </span>  doesn’t impose any length restrictions on tracks, so you can release a song of any length, including tracks longer than 10 minutes. Whether it’s a long instrumental or an epic composition, your track can be distributed without limitations. 🎶
         </span>
