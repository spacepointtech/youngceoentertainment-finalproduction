...
const FaqComponent = () => {
  ...
  return (
    ...
    <div className="text-white text-4xl font-bold font-['Poppins']">Can I release music in specific countries?  </div>
    <div className="self-stretch h-5" />
    <div className="self-stretch"><span className="text-[#ebebeb] text-base font-normal font-['Poppins'] leading-normal">  
         
    Yes, you can! With <span className='font-bold'> Young CEO Entertainment </span> , you have the flexibility to choose where your music will be distributed. You can select the countries or regions you want to release your music in, ensuring you reach the right audience. 🌎
