...
const FaqComponent = () => {
  ...
  return (
    ...
    <div className="text-white text-4xl font-bold font-['Poppins']"> Can I view my music analytics in more detail? 📊  </div>
    <div className="self-stretch h-5" />
    <div className="self-stretch"><span className="text-[#ebebeb] text-base font-normal font-['Poppins'] leading-normal">  
         
    Definitely! When you distribute music with <span className='font-bold'>  Young CEO Entertainment, </span> you can access detailed <span className='font-bold'> analytics  </span> through your dashboard. You can track your streams, downloads, and royalties across different platforms, giving you a clear view of how your music is performing worldwide. 📈
