...
const FaqComponent = () => {
  ...
  return (
    ...
    <div className="text-white text-4xl font-bold font-['Poppins']"> How much does it cost to release music with Young CEO Entertainment? 💰  </div>
    <div className="self-stretch h-5" />
    <div className="self-stretch"><span className="text-[#ebebeb] text-base font-normal font-['Poppins'] leading-normal">  
         
    The cost to release music with <span className='font-bold'>  Young CEO Entertainment </span> depends on the subscription plan you choose. We offer affordable pricing, starting at <span className='font-bold'> ₹399/year </span> for a Single track plan. This allows you to distribute music to major platforms with no hidden fees. More advanced plans with additional features like analytics and promotional tools are available. You can find full details on <Link href={"/pricing"} 
    className='underline text-[#e97f18]'> pricing page  </Link> ! 🚀
