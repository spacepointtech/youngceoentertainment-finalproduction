...
const FaqComponent = () => {
  ...
  return (
    ...
    Yes, <span className='font-bold'> Young CEO Entertainment  </span> gives you the flexibility to set your own price for your music. Whether you want to charge a certain amount per track or set a price for an album, you have full control. This helps you align your pricing strategy with your fanbase and marketing plan. 💵
         </span>
