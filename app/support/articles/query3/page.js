...
const FaqComponent = () => {
  ...
  return (
    ...
    <div className="text-white text-4xl font-bold font-['Poppins']"> Can I release music for multiple artists from one account? 🎤  </div>
    <div className="self-stretch h-5" />
    <div className="self-stretch"><span className="text-[#ebebeb] text-base font-normal font-['Poppins'] leading-normal">  
         
    Yes! You can manage and release music for multiple artists under a single <span className='font-bold'> Young CEO Entertainment </span> account. Each artist will have their own profile, but you can handle all releases from one central dashboard, making it easier to manage your catalog. 🙌
