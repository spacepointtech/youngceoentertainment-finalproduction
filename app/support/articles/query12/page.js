...
const FaqComponent = () => {
  ...
  return (
    ...
    <div className="text-white text-4xl font-bold font-['Poppins']"> How do I use my Young CEO Entertainment discount code? 💳 </div>
    <div className="self-stretch h-5" />
    <div className="self-stretch"><span className="text-[#ebebeb] text-base font-normal font-['Poppins'] leading-normal">  
         
    If you have a discount code, you can apply it at checkout when purchasing a subscription plan or releasing music. Simply enter the code, and the discount will be applied to the total cost. It’s an easy way to save on your music distribution! 🎉
         </span>
