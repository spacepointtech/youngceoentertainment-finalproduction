...
export default function AudiencePage() {
  const [selectedSection, setSelectedSection] = useState("Listeners");
  ...
  const sections = ["Listeners", "Segments", "Location"];
  const timeFilters = ["7 Days", "25 Days", "12 Months", "Filters"];
    ...
    <div className="flex flex-col lg:flex-row w-full min-h-screen bg-[#0F0F0F] font-poppins">
      ...
      <main className="flex-1 p-4 sm:p-6 flex flex-col gap-6 text-white">
        ...
        <div className="mx-5 lg:mx-10">
          ...
          {/* Analytics Box */}
          <div className="mt-10 p-2 sm:p-6 sm:py-12 bg-gradient-to-r from-black via-[#2d2d2d] to-black rounded-2xl"
          style={{
          ...
          >
            <div className="font-poppins px-10 text-white text-xl sm:text-[28px] mb-6 sm:mb-10 font-bold">
              Welcome to your Analytics
            </div>
            <div className="grid grid-cols-2  px-10 md:grid-cols-4 gap-4 sm:gap-6 mt-6">
              {['Listeners', 'Streams', 'Average', 'Saves'].map((title, index) => (
                <div key={index} className="flex flex-col items-center">
                  <div className="bg-gradient-to-tr from-black via-black to-black w-full h-32 sm:h-40 rounded-lg flex flex-col justify-center items-center">
                    <div className="text-sm uppercase">{title}</div>
                  ...
                  <div className="w-[180px]  h-1 sm:h-2 bg-[#616161]  rounded-3xl"></div>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="mt-10">
            ...
            {selectedSection === "Listeners" && <div>
           
               <p className='text-orange-500 justify-center text-center  font-poppins text-2xl mt-20'> Your Graph will be Displayed Here!  </p>
              </div>}
            {selectedSection === "Segments" && <div>
              
              <p className='text-orange-500 font-poppins text-center text-2xl mt-20'> Your Segments Will be Displayed Here! </p>
