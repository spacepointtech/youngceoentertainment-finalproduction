    ...
    <div className="bg-[#1E1E1E] min-h-screen flex flex-col items-center text-white font-[Poppins]">
      ...
      <div className="absolute top-5 left-5">
        <Image
          ...
          width={100}
          height={100}
          className="w-[90px] h-[90px] mt-12 md:w-[100px] md:h-[100px]" // Adjust logo size for smaller screens
        />
      </div>
...
function Button({ icon, text }) {
  return (
    <div className="flex items-center justify-between w-full md:w-[480px] bg-[#191919] border-b border-[#757575] py-4 md:py-5 px-4 md:px-6">
      ...
      <button className="text-xs md:text-sm bg-[#e97f18] text-white px-8 md:px-12 py-2 md:py-3 rounded-md">
        Play
      </button>
    </div>
  );
