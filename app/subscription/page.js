...
export default function Pricing() {
  ...
  return (
    <div
      className="w-full min-h-screen flex justify-center items-center bg-black font-p overflow-x-hidden"
      style={{ zoom: '1' }} // Ensures the default zoom
    >
      <div className="w-[1440px] h-[1543px] relative">
        {/* Top Section */}
...
<div className="w-[308px] left-[43px] top-[921.53px] absolute justify-start items-start inline-flex">
    ...
    Get started
        ...
        {activeTab === 'singleTrack' && (
          <div>
            <div className="w-[1240px] h-[252px] justify-center items-center inline-flex"></div>
              ...
              <div className="grow shrink basis-0 self-stretch pl-px py-[3px] justify-center items-center inline-flex">
                <div className="grow shrink basis-0 self-stretch justify-between items-center inline-flex">
                  <div className="w-[689px] flex-col justify-start items-start gap-4 inline-flex">
                    <div className="w-[424px] text-white text-[28px] font-bold font-['Poppins']">
                      Distribute a Single Track
                    </div>
                    <div className="self-stretch h-[92px] text-white text-xl font-normal leading-[38px]">
                      One-time distribution for a single song. Get your music on top platforms without a subscription.
                    </div>
                    <div className="self-stretch text-white text-xl font-bold leading-[38px]">
                      Note: This plan does not include dashboard access.
                    </div>
                  </div>
                  <div className="w-[275px] flex-col justify-start items-end gap-5 inline-flex">
                    <div className="self-stretch text-center text-white text-[32px] ml-10 font-semibold ">
                      ₹ 399 / Track
                    </div>
                    <Link href="/signup" className="text-center text-white text-xl font-bold leading-tight">
